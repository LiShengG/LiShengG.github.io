/**
 * 提示：如您想使用JS版本的配置文件可参考：https://github.com/LiShengG/vuepress-theme-vdoing/tree/a2f03e993dd2f2a3afdc57cf72adfc6f1b6b0c32/docs/.vuepress
 */
...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  themeConfig: {
    ...
    repo: 'LiShengG/LiShengG.github.io', // 导航栏右侧生成Github链接
    searchMaxSuggestions: 1, // 搜索结果显示最大数
    lastUpdated: '上次更新', // 开启更新时间，并配置前缀文字   string | boolean (取值为git提交时间)
    docsDir: 'docs', // 编辑的文件夹
    docsBranch: 'docs', // 编辑的文件所在分支，默认master。 注意：如果你的分支是main则修改为main
    editLinks: true, // 启用编辑
    editLinkText: '编辑',
  ...
  plugins: <UserPlugins>[
    ...
    [
      'vuepress-plugin-comment', // 评论
      {
        choosen: 'gitalk',
        options: {
          clientID: 'Ov23liKHmgKPPz73r7rW',
          clientSecret: '70c8ba4189e8cd41afcecb5c5a82f62d63c11149',
          repo: 'gitalk-comments', // GitHub 仓库
          owner: 'LiShengG', // GitHub仓库所有者
          admin: ['LiShengG'], // 对仓库有写权限的人
